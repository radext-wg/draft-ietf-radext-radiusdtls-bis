...
* Implementations SHOULD NOT keep a connection open for longer than the validity span of the peer certificate.  At the time the certificate expires, the connection SHOULD be closed and re-opened.
